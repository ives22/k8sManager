<template>
    ...
    <el-drawer
        ...
        <template #default>
            <el-row type="flex" justify="center">
                <el-col :span="20">
                    <el-form ref="createWorkflow" :rules="createWorkflowRules" :model="createWorkflow" label-width="100px">
...
export default {
    ...
    methods: {
        ...
        getWorkflows() {
            ...
            this.getWorkflowsData.params.cluster = this.selectClusterValue
        ...
        createWorkflowFunc() {
            ...
            this.createWorkflowData.params.cluster = this.selectClusterValue
            ...
            //发送请求
            httpClient.post(this.createWorkflowData.url, this.createWorkflowData.params).then(res => {
                this.$message.success({
                    message: res.msg
                })
                this.getWorkflows()
