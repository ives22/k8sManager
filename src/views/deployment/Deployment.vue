<template>
    <div class="deploy">
                        ...
                        <el-row>
                            ...
                            <el-col :span="2">
                                <div>
                                    ...
                                    @click="createDeploymentDrawer = true">创建</el-button>
                                </div>
                            </el-col>
                            <!-- 搜索输入框和搜索按钮 -->
                            <el-col :span="6">
            ...
            <el-col :span="24">
                <div>
                    <el-card class="deploy-body-card" shadow="never" :body-style="{padding:'5px'}">
                        ...
                        <el-table style="width: 100%; font-size:12px; margin-bottom:10px" :data="deploymentList" v-loading="appLoading">
                            <!-- 最左侧留出20px的宽度，更加美观 -->
                            ...
                            <el-table-column align=left label="Deployment名">
                                ...
                                <template v-slot="scope">
                                    <!-- <a href="" class="deploy-body-deployname">{{scope.row.metadata.name}}</a> -->
        ...
        <el-Drawer v-model="createDeploymentDrawer"
        :direction="direction"
...
export default {
    ...
    methods: {
        ...
        createDeployFunc(){
            ...
            this.createDeploymentData.params.cluster = this.selectClusterValue

            // 发起请求
            httpClient.post(this.createDeploymentData.url, this.createDeploymentData.params).then(res=>{
        ...
        getDeployments() {
            ...
            this.getDeploymentsData.params.cluster = this.selectClusterValue
            // 发起请求获取数据
            httpClient.get(this.getDeploymentsData.url, {params: this.getDeploymentsData.params}).then(res => {
        ...
        getDeploymentDetail(e){
            ...
            this.getDeploymentDetailData.params.cluster = this.selectClusterValue
            // 发起请求获取数据
            httpClient.get(this.getDeploymentDetailData.url, {params: this.getDeploymentDetailData.params}).then(res => {
                //响应成功，获得deployment详情
        ...
        updateDeployment(){
            ...
            this.updateDeploymentData.params.cluster = this.selectClusterValue
            httpClient.put(this.updateDeploymentData.url, this.updateDeploymentData.params).then(res => {
                this.$message.success({
                    message: res.msg
                })
                //更新后重新获取列表
        ...
        scaleDeployment(){
            ...
            this.scaleDeploymentData.params.replicas = this.scaleNum
            this.scaleDeploymentData.params.cluster = this.selectClusterValue
        ...
        delDeployment(e){
            ...
            this.deleteDeploymentData.params.deployment_name = e.row.metadata.name 
            this.deleteDeploymentData.params.cluster = this.selectClusterValue
            httpClient.delete(this.deleteDeploymentData.url, {data: this.deleteDeploymentData.params}).then(res => {
                this.$message.success({
                    message: res.msg
                })
                // 删除后重新获取列表
