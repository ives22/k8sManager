        ...
        <el-card class="login-card">
            ...
            <el-form :model="loginData" :rules="loginDataRules" ref="loginData">
                ...
                <el-form-item prop="password">
                    <!-- 密码 -->
                    <el-input prefix-icon="Lock" v-model.trim="loginData.password" maxlength="16" show-password placeholder="请输入密码" clearable @keyup.enter="handleLogin()"></el-input>
                </el-form-item>
                <el-form-item>
                    <!-- 登录按钮 -->
...
export default{
    ...
    methods: {
        //登录方法
        handleLogin() {
            httpClient.post(this.loginUrl, this.loginData).then(res => {
                //账号密码校验成功后的一系列操作
